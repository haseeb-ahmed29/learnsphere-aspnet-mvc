...
A database-backed ASP.NET Core MVC application for managing learnsphere workflows.

## Purpose

This repository was created as a practical project to explore the design and implementation of **LearnSphere**. It can be used as a learning reference, a starting point for further development, or a demonstration of the related business workflow.
